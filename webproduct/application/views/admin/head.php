...
<!-- <script language="javascript" src="<?php echo public_url('admin') ?>/ckfinder/ckeditor.js" type="text/javascript"></script> -->
<script language="javascript" src="<?php echo public_url('admin') ?>/ckeditor/ckeditor.js" type="text/javascript"></script>
