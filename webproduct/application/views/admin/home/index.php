		...
		<table width="100%" cellspacing="0" cellpadding="0" class="sTable myTable">
			<tbody>
					...
					<tr>
							...
							<td style="width:120px;" class="textR webStatsLink red"><?php echo number_format($danhso); ?> VNĐ</td>
					</tr>

				    
				    <tr>
							<td class="fontB blue f13">Doanh số hôm nay</td>
							<td style="width:120px;" class="textR webStatsLink red"><?php echo number_format($danhthutheongay); ?> VNĐ</td>
					</tr>
