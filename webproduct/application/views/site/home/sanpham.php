...
<h3 class="section-title" style="font-family: 'regular';">Sản phẩm mới</h3>
                        ...
                        <div class="products">
                            ...
                            <div class="product">
                                ...
                                <div class="product-info text-left">
                                    <p class="name" style="font-family: 'regular'; font-size: 20"><a href="<?php echo base_url('product/view/'.$row->id) ?>"><?php echo $row->name ?></a></p>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image" >
                                                <img href="<?php echo base_url('product/view/'.$row->id) ?>" src="<?php echo base_url('upload/product/'.$row->image_link) ?>" style="width: 270px;height: 347px;" >
                                                <?php if($row->discount > 0):?>
                                                <div class="tag sale"><span>sale</span></div>
                                                <?php else: ?>
                                                    <div class="tag new"><span>new</span></div>
...
<h3 class="section-title" style="font-family: 'regular';">Sản phẩm mua nhiều</h3>
<div class="search-result-container">
    <div id="myTabContent" class="tab-content">
        <div class="tab-pane active " id="grid-container">
            <div class="category-product  inner-top-vs">
                    ...
                    <?php foreach($product_buy as $row):?>
                        ...
                        <div class="products">
                            ...
                            <div class="product">
                                ...
                                <div class="product-info text-left">
                                    <h3 class="name"><a href="detail.html"><?php echo $row->name ?></a></h3>
                                    ...
                                    <div><span>Lượt mua: <?php echo $row->buyed?></span></div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image" >
                                                <a href="<?php echo base_url('product/view/'.$row->id) ?>"><img alt="" src="<?php echo base_url('upload/product/'.$row->image_link) ?>" style="width: 270px;height: 347px;" ></a>
                                            </div>
                                        </div><!-- /.product-image -->
                                    </div><!-- /.col -->
                                    <div class="col col-sm-8 col-lg-8">
