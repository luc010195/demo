...
<h3 class="section-title" style="font-family: 'regular';">Kết quả tìm kiếm với giá từ: <?php echo number_format($price_from) ?> tới <?php echo number_format($price_to) ?> VNĐ</h3>
